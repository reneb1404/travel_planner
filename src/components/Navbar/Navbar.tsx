"use client";
import { Moon, Plane, Sun, User } from "lucide-react";
...
export default function Navbar() {
	...
	const toggleTheme = () => {
		setTheme((prevTheme) => (prevTheme === "black" ? "bumblebee" : "black"));
	};
	...
	return (
		<div className="navbar bg-base-100 shadow-lg">
			<div className="navbar-start">
				...
				<a className="btn btn-ghost normal-case text-xl rounded-md">
